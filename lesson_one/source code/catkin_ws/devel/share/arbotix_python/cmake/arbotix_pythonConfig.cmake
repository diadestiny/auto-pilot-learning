...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/lin/catkin_ws/src/arbotix_ros/arbotix_python)
  set(arbotix_python_DEVEL_PREFIX /home/lin/catkin_ws/devel)
  ...
  set(arbotix_python_INSTALL_PREFIX /home/lin/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lin/catkin_ws/src/arbotix_ros/arbotix_python/${idir}'.  ${_report}")
    endif()
